...
const ConversionBlock = React.memo((props: PropsType) => {
  ...
  useEffect(() => {
    ...
    if (props.currency[selectedValue].rateBuy) {
      newArray[selectedValue].ratio = props.currency[selectedValue].rateBuy;
    } else if (props.currency[selectedValue].rateCross) {
      newArray[selectedValue].ratio = props.currency[selectedValue].rateCross;
    } else {
      newArray[selectedValue].ratio = 1;
    }

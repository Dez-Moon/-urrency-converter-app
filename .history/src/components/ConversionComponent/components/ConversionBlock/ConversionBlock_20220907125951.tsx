...
import "./styles.scss";
import { CurrencyWithValuesType } from "../../ConversionComponent";

type PropsType = {
  currency: Array<CurrencyType>;
  index: number;
  currencyWithValues: CurrencyWithValuesType;
  setCurrencyWithValues: React.Dispatch<
    React.SetStateAction<CurrencyWithValuesType>
  >;
};

...
const currency = new Map<string, CurrencyType>([
  ...
  ["840", { code: 840, currency: "USD", name: "Доллар США", flag: flag840 }],
  ["978", { code: 978, currency: "EUR", name: "Евро", flag: flag978 }],
  [
    "985",
    { code: 985, currency: "PLN", name: "Польский злотый", flag: flag985 },
  ],
  ["203", { code: 203, currency: "CZK", name: "Чешская крона", flag: flag203 }],
  [
    "826",
  ...
  ["392", { code: 392, currency: "JPY", name: "Японская йена", flag: flag392 }],
  ["949", { code: 949, currency: "TRY", name: "Турецкая лира", flag: flag949 }],
]);

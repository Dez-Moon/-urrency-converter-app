...
const slice = createSlice({
  ...
  reducers: {
    ...
    setSelectedCurrencyAC(
      ...
      state.windowsWithCurrency.forEach((currency) => {
        const object: any = {
          value: currency.value,
          ratio: currency.ratio,
          listOfCurrenciesOpen: currency.listOfCurrenciesOpen,
          selectedCurrency: { ...currency.selectedCurrency },
        };
        newArray.push(object);
      });
      state.windowsWithCurrency.splice(action.payload.index, 1, Object);
      debugger;
    },
    addErrorAC(
      state,

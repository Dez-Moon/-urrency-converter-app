...
import { CurrencyResponseType, CurrencyType, WindowsWithCurrencyType } from "../types/types";

type InitialStateType = {
  currency: Array<CurrencyType>, windowsWithCurrency: Array<WindowsWithCurrencyType>
}
const initialState: InitialStateType = { currency: [], windowsWithCurrency: [] }
const slice = createSlice({
  name: "currency",
  initialState { currency: [], windowsWithCurrency: [] } as InitialStateType,
  reducers: {
    setCurrencyAC(
      state,

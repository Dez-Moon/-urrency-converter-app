...
const slice = createSlice({
  ...
  reducers: {
    ...
    setListOfCurrenciesOpenAC(
      ...
      state.windowsWithCurrency.forEach((el, i) => {
        el.listOfCurrenciesOpen = action.payload.index
          ? action.payload.index === i
            ? !el.listOfCurrenciesOpen
            : false
          : false;
      });
    },
...
export const setListOfCurrenciesOpenTC = (index: number | null) => {};

...
function App() {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        res.data.forEach((currencyRes: CurrencyResponseType, index: number) => {
          if (
            newArray.length > 0 &&
            currencyRes.currencyCodeA === newArray[newArray.length - 1].code
          ) {
            return;
          }
          if (newArray.length === 0) {
            const currencyCopy = {
              ...
              code: currencyRes.currencyCodeB,
            } as CurrencyType;
          ...
          if (currencyBase.has(String(currencyRes.currencyCodeA))) {
            const currencyCopy = {
              ...
              code: currencyRes.currencyCodeA,
            } as CurrencyType;
